...
This repository contains a hardened, honest workshop-only robotics paper draft for `embodied_model_repair_memory`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/63.pdf`
